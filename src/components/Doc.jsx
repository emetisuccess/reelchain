    ...
    <div className="lg:container md:container md:mx-auto">
      ...
      <div className="home lg:w-3/5 md:w-3/5  sm:w-4/5 w-9/12 ">
        <div className="home-header">
          <h2 className="text-4xl font-bold md:text-6xl text-white sm:text-5xl">Introduction</h2>
          ...
          <p className="text-white text-lg my-2">
            ReelChain offers viewers unrestricted access to diverse films and ensures transparent and fair revenue distribution.
          </p>
          <p className="text-white text-lg my-2">
            ReelChain combines decentralized content hosting, blockchain-based payments, NFTs, and community governance to create a
            transparent, secure, and community-driven movie streaming experience.
          </p>
          <p className="text-white text-lg my-2">
            The movie streaming industry has experienced rapid growth, yet it remains dominated by a few centralized platforms.
          </p>
          <p className="text-white text-lg my-2">
            These platforms often impose high fees, restrict content availability due to regional licensing, and compromise user data
            privacy.
          </p>
          <p className="text-white text-lg my-2">
          ...
          <p className="text-white text-lg my-2">
            Reelchain combines decentralised content hosting , blockchain based payments, NFTs and community governance to create a
            transparent,secure and community driven movie streaming experience.
          </p>
        </div>
        <Link to="/problem-statement" className="my-16  flex items-center justify-between px-2 border border-white-200">
          <div>
